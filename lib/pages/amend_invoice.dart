...
class AmendInvoicePage extends StatefulWidget{
  ...
  @override
  _AmendInvoicepageState createState()=>_AmendInvoicepageState();
}

class _AmendInvoicepageState extends State<AmendInvoicePage> {
  String searchQuery = "";
...
Future<void> _findInvoice(String compid, String invno) async {
  ...
  bool _validateInputs() {
    ...
    //   // remarkErrorMessage = 'Please enter reason';
    //   remarks.addListener( (){
    //   String remark = remarks.text;
    //     if (remark.isNotEmpty) {
    //       remarkErrorMessage = null;
    //     }else{
    //       remarkErrorMessage = 'Please enter reason';
    //     }
    //   });
    ...
    if (remarks.text.isEmpty) {
       setState(() {
          remarkErrorMessage = 'Please enter reason'; // Set the error message
        });
      ScaffoldMessenger.of(context).showSnackBar(
      ...
      setState(() {
        remarkErrorMessage = null; // No error message 
        reason = remarks.text;
        // log(remark);
