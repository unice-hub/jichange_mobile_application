    ...
    return Row(
      children: [
        ...
        ElevatedButton.icon(
          onPressed: () async {
            await fetchInvoices();
            await downloadCancelledInvoicePDF(context, invoices);
          },
...
Future<void> downloadCancelledInvoicePDF(BuildContext context, List<InvoiceData> invoices) async {
  ...
  final file = File('${directory.path}/cancelled_invoice_details.pdf');
  ...
  await Printing.sharePdf(
    bytes: pdfBytes,
    filename: 'cancelled_invoice_details.pdf',
  );
}
...
Future<void> createAndDownloadExcel(List<InvoiceData> invoices) async {
  ...
  final sheet = excel['Cancelled Invoice'];
  ...
  for (final invoice in invoices) {
    ...
    sheet.appendRow([
      ...
      excelLib.TextCellValue(invoice.invoiceAmount.toString()),
...
Directory tempDir = await getTemporaryDirectory();
  String filePath = '${tempDir.path}/Cancelled Invoice.xlsx';
